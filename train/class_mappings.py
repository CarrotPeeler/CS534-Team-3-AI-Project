...
# links class NAMES to class INDICES for NewPlantDisease Dataset
newplantdiseases_name_mapping = {'Apple___Apple_scab': 0, 
                                'Apple___Black_rot': 1,
...
# links class INDICES to class NAMES for PlantDoc Object Detection Dataset
plantdoc_od_idxs_mapping = {0:'Apple Scab Leaf',  
                            1:'Apple leaf',
                            2:'Apple rust leaf', 
...
# maps PlantDoc Classification Dataset NAMES to class INDICES
plantdoc_cls_name_mapping = {'Apple Scab Leaf': 0, 
                            'Apple leaf': 1, 
                            'Apple rust leaf': 2, 
...
# maps PlantDoc class NAMES to NewPlantDisease class INDICES
plantdoc_od_to_npds_mapping  = {'Apple Scab Leaf':0, 
                                'Apple leaf':3, 
                                'Apple rust leaf':2, 
